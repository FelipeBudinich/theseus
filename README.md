...
During source serving, images and audio are loaded from `/games/example/media/...`. During a baked build, Theseus can provide atlas manifests that let the runtime resolve the same `games/example/media/...` paths from generated assets in `/dist/assets/...`.
