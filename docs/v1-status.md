...
- `esm-smoke.html` verifies the lower-level `lib/impact/ig.js` bootstrap path in a browser.
- `esm-engine-smoke.html` verifies the full `lib/impact/impact.js` engine entry, including `ig.main` and class-registry access.
