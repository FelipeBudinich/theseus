...
const registerLevel = (name, levelData) => {
	var normalizedName = normalizeLevelName(name);
...
const getLevelByName = function( name ) {
	return levels[normalizeLevelName(name)] || null;
};
...
ig.Game.normalizeLevelName = normalizeLevelName;
ig.Game.registerLevel = registerLevel;
ig.Game.getLevelByName = getLevelByName;
