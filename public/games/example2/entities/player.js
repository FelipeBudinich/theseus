...
ig.EntityPlayer = ig.Entity.extend({
	...
	animSheet: new ig.AnimationSheet('games/example2/media/player.png', 75, 100),
	
	sfxHurt: new ig.Sound('games/example2/media/sounds/hurt.*'),
	sfxJump: new ig.Sound('games/example2/media/sounds/jump.*'),
