...
const playGameMusic = () => {
	ig.music.add('games/example2/media/music/energy-warrior.*', 'energy-warrior');
	ig.music.loop = true;
...
const MyGame = ig.Game.extend({
	...
	font: new ig.Font('games/example2/media/fredoka-one.font.png'),
	heartFull: new ig.Image('games/example2/media/heart-full.png'),
	heartEmpty: new ig.Image('games/example2/media/heart-empty.png'),
	coinIcon: new ig.Image('games/example2/media/coin.png'),
...
const MyTitle = ig.Game.extend({
	...
	title: new ig.Image('games/example2/media/title.png'),
	font: new ig.Font('games/example2/media/fredoka-one.font.png'),
	...
	init: function() {
		...
		ig.input.bind('Gamepad0FaceRight', 'shoot');
		ig.input.bind('Gamepad0FaceLeft', 'shoot');
...
if (ig.ua.mobile) {
	var buttonImage = new ig.Image('games/example2/media/touch-buttons.png');
